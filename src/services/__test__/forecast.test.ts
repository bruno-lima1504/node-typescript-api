...
describe('Forecast Service', () => {
  ...
  it('should return the forecast for a list of beaches', async () => {
    //exemplo ruim de mock dessa forma nao estamos mockando o metodo e sim substituindo o metodo, vai ficar de exemplo e iremos refatorar futuramento
  ...
  it('should return an empty list when beaches arrays is empty', async () => {
  ...
  it('should throw internal processing erro when something goes wrong during the rating process', async () => {
    const beaches: Beach[] = [
      {
        lat: -33.792726,
        lng: 151.289824,
